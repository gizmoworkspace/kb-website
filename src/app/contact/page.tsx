    ...
    <div ref={pageRef} className="bg-navy-dark">
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="reveal-block glass rounded-xl p-16 text-center border border-gold/10">
            ...
            <p className="text-gray-600 text-sm mt-2">Direct access to Kayden. 30 minutes. No pitch.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="reveal-block glass rounded-xl p-10 text-center">
            <p className="text-gray-400 italic mb-6">&ldquo;The call alone was worth it—I&apos;d been researching for months and he organized everything in 30 minutes.&rdquo;</p>
            <p className="text-xs text-gray-600 mb-8">— Testimonial placeholder. Real client testimonials coming soon.</p>
      ...
      <section className="py-24 lg:py-32">
        <div className="reveal-block max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-500 mb-10">Direct access to Kayden. 30 minutes. No pitch.</p>
